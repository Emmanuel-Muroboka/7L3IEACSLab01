...
void question1() {
    ...
    std::cout << "Question 1 Problem 1" << std::endl;
    char var1, var2;
...
void question4() {
    std::cout << "\n\nQuestion 4 Problem 1" << std::endl;
    std::cout << "First" << std::endl;
}

void question5() {
    std::cout << "\n\nQuestion 5 Problem 1" << std::endl;
    char x;
